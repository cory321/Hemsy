...
-- Recreate the view with LEFT JOINs to include all garments
...
COMMENT ON VIEW public.garments_with_clients IS 'Flattened view of garments with client information for easier searching and filtering. Uses LEFT JOINs to include all garments, even those without orders or clients.';
