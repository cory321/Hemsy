...
import GarmentHistoryOptimistic from '../GarmentHistoryOptimistic';
...
describe('GarmentHistoryOptimistic', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it('shows optimistic updates immediately with loading indicator', async () => {
    ...
    rerender(<GarmentHistoryOptimistic garmentId="test-garment-id" />);
