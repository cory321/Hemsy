// Deprecated in favor of MUI X Date Pickers.
// Keeping a minimal wrapper for compatibility if imported anywhere.
'use client';
    ...
    '& .react-datepicker': {
      ...
      '& .react-datepicker__day--today': {
        ...
        '&:not(.react-datepicker__day--selected):not(:empty)': {
          ...
          backgroundColor: `rgb(${(theme as any).vars.palette.primary.mainChannel} / 0.16)`,
          '&:hover': {
            backgroundColor: `rgb(${(theme as any).vars.palette.primary.mainChannel} / 0.24)`,
          },
      ...
      '& .react-datepicker__month-text--today': {
        ...
        '&:not(.react-datepicker__month-text--selected)': {
          ...
          '&:hover': {
            backgroundColor: `rgb(${(theme as any).vars.palette.primary.mainChannel} / 0.04)`,
          },
        },
      },
      '& .react-datepicker__year-text--today': {
        ...
        '&:not(.react-datepicker__year-text--selected)': {
          ...
          '&.react-datepicker__year-text--keyboard-selected': {
            color: theme.palette.primary.main,
            backgroundColor: `rgb(${(theme as any).vars.palette.primary.mainChannel} / 0.06)`,
            '&:hover': {
              color: theme.palette.primary.main,
              backgroundColor: `rgb(${(theme as any).vars.palette.primary.mainChannel} / 0.06)`,
            },
      ...
      '& .react-datepicker__day--keyboard-selected': {
        ...
        '&.react-datepicker__day--in-range:not(.react-datepicker__day--range-end)':
          {
            backgroundColor: `rgb(${(theme as any).vars.palette.primary.mainChannel} / 0.12) !important`,
            '&:hover': {
              backgroundColor: `rgb(${(theme as any).vars.palette.primary.mainChannel} / 0.12) !important`,
            },
          },
...
type AppReactDatepickerProps = {
  boxProps?: React.ComponentProps<typeof Box>;
  children?: React.ReactNode;
};

export default function AppReactDatepicker({
  boxProps,
  children,
}: AppReactDatepickerProps) {
  return (
    <StyledReactDatePicker {...boxProps}>{children}</StyledReactDatePicker>
  );
}
