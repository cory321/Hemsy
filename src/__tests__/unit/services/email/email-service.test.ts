...
describe('EmailService', () => {
	...
	it('does not break when adding confirmation link for pending scheduled emails', async () => {
		// This is a smoke test to ensure confirmation tokens are handled inline
		// The sendConfirmationRequest method was integrated into sendAppointmentEmail
		expect(typeof emailService.sendAppointmentEmail).toBe('function');
	});
});
