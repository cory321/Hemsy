...
// The OrdersList component now uses a table layout instead of cards
// No need to mock OrderCardMinimal since it's not used anymore
	...
	data: [
		{
			...
			tax_cents: 0,
			notes: 'Test order 1',
			order_due_date: '2024-01-10T00:00:00Z',
		...
		},
		{
			...
			tax_cents: 0,
			notes: null,
			order_due_date: '2024-01-15T00:00:00Z',
...
describe('OrdersList', () => {
	...
	it('should navigate to order detail page on table row click', async () => {
		...
		// Find and click the table row (by clicking on the order number)
		const orderNumber = screen.getByText('#001');
	...
	it('should format dates correctly', async () => {
		...
		// The table shows due dates - check that some date format is displayed
		// The exact format may vary based on the date formatting utility
