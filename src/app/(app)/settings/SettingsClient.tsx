...
import { updateShopBusinessInfo } from '@/lib/actions/shops';
...
export function SettingsClient({
	...
	const [businessInfo, setBusinessInfo] = useState({
		business_name:
			initialShopData?.business_name || initialShopData?.name || '',
		email: initialShopData?.email || '',
		phone_number:
			initialShopData?.phone_number || initialShopData?.businessPhone || '',
		mailing_address:
			initialShopData?.mailing_address ||
			initialShopData?.businessAddress ||
			'',
		location_type:
			initialShopData?.location_type ||
			('shop_location' as 'home_based' | 'shop_location' | 'mobile_service'),
		timezone:
			initialShopData?.timezone ||
