			...
			{payments.length > 0 && (
				<PaymentManagement
					payments={payments.map((payment) => ({
						...
						// Stripe fee tracking fields
						...(payment.stripe_fee_cents !== null &&
							payment.stripe_fee_cents !== undefined && {
								stripe_fee_cents: payment.stripe_fee_cents,
							}),
						...(payment.net_amount_cents !== null &&
							payment.net_amount_cents !== undefined && {
								net_amount_cents: payment.net_amount_cents,
							}),
						...(payment.stripe_fee_details && {
							stripe_fee_details: payment.stripe_fee_details,
						}),
					}))}
