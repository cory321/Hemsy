 ...
 * @deprecated Use validateFutureDateTimeForTimezone from date-time-utc.ts for timezone-aware validation
 */
 ...
 * @deprecated Use validateAppointmentDateTimeForTimezone for timezone-aware validation
 */
